...
class Mastermind
  ...
  def initialize
    # set up board early during play method but keep this original in case need to revert back to it
  ...
  def play
    ...
    @messages.welcome # explains rules
...
class Player
  ...
  # common sub-method called by Human class create_code and guessed_code methods
...
class Messages
  ...
  def welcome
    ...
    welcome_message = [
        'RULES: The codemaker creates a 4-digit code. Each',
        'digit (representing a color) is in the range 1 - 6.', 
